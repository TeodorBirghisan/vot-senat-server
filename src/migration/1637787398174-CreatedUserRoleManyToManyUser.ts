...
export class CreatedUserRoleManyToManyUser1637787398174 implements MigrationInterface {
    name = 'CreatedUserRoleManyToManyUser1637787398174'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user_role" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, CONSTRAINT "PK_fb2e442d14add3cefbdf33c4561" PRIMARY KEY ("id"))`);
